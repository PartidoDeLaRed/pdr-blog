...
Consider using our ready-to-run WordPress on Cloud Storage - [Oblaksoft Yapixx, the 1st WordPress website on Amazon S3](http://www.oblaksoft.com/documentation/yapixx/ "Yet Another Picture Sharing Site") as a starting point and a reference of such configuration. Refer to the complete [WordPress on S3](http://www.slideshare.net/artemlivshits/wordpress-on-s3-stepbystep) and [WordPress on Google Cloud Storage](http://www.slideshare.net/artemlivshits/wordpress-on-google-cloud-storage-virtual-appliance) step-by-step guides for extra pointers in setting up WordPress on cloud storage.
...
For additional information about WordPress on Cloud Storage please check out these detailed step-by-step instructions: [WordPress on S3](http://www.slideshare.net/artemlivshits/wordpress-on-s3-stepbystep) and [WordPress on Google Cloud Storage](http://www.slideshare.net/artemlivshits/wordpress-on-google-cloud-storage-virtual-appliance).
...
For quick access to wp-config.php, log into Webmin, select Others -> Custom Commands.
...
Yes, you can configure WP2Cloud to use a separate Media Server. The configuraiton instructions are provided [here](http://wordpress.org/extend/plugins/wp2cloud-wordpress-to-cloud/installation/).
